...
FlavorRoute is a modern web application built using React that helps users explore restaurants, apply filters, and perform utility tasks like bill calculation and digital signature confirmation.

This project was developed as part of a Web Programming coursework to demonstrate the practical implementation of frontend technologies and interactive UI design.
